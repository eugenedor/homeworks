...
-- Дата скрипта: 28.08.2018 23:13:49
-- Версия сервера базы данных источника: 11.00.2100
-- Строка соединения источника: Data Source=EUGENE_D\SQL2012X64;Encrypt=False;Integrated Security=False;User ID=sa
-- Версия сервера базы данных получателя: 11.00.2100
-- Строка соединения получателя: Data Source=EUGENE_D\SQL2012X64;Encrypt=False;Integrated Security=False;User ID=sa
-- Выполните скрипт в базу ToolsStore2, чтобы синхронизировать ее с базой ToolsStore
--
...
--
-- Резервное копирование базы данных ToolsStore2
--
--
-- Создать папку для резервной копии базы данных
--
IF OBJECT_ID('xp_create_subdir') IS NOT NULL
  EXEC xp_create_subdir N'C:\Program Files\Microsoft SQL Server\MSSQL11.SQL2012X64\MSSQL\Backup'
--
...
SET @filepath =
/*определить основную часть*/ N'C:\Program Files\Microsoft SQL Server\MSSQL11.SQL2012X64\MSSQL\Backup\' + @db_name + '_' +
...
--
-- Выключение DML триггеров таблицы dbo.RS_PRODUCT
--
GO
DISABLE TRIGGER ALL ON dbo.RS_PRODUCT
GO

IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END

--
-- Удаление ограничений таблицы dbo.RS_PRICE
--
ALTER TABLE dbo.RS_PRICE
  DROP CONSTRAINT FK_RS_PRICE_CT_VAT
ALTER TABLE dbo.RS_PRICE
  DROP CONSTRAINT FK_RS_PRICE_RS_PRODUCT
GO

IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END

--
-- Удаление ограничений таблицы dbo.RS_PRODUCT
--
ALTER TABLE dbo.RS_PRODUCT
  DROP CONSTRAINT FK_RS_PRODUCT_CT_BRAND
ALTER TABLE dbo.RS_PRODUCT
  DROP CONSTRAINT FK_RS_PRODUCT_CT_IMAGE
ALTER TABLE dbo.RS_PRODUCT
  DROP CONSTRAINT FK_RS_PRODUCT_SK_EQUIPMENT
ALTER TABLE dbo.RS_PRODUCT
  DROP CONSTRAINT FK_RS_PRODUCT_SK_MODEL
GO

IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END

--
-- Удаление ограничений таблицы dbo.SK_EQUIPMENT
--
ALTER TABLE dbo.SK_EQUIPMENT
  DROP CONSTRAINT FK_SK_EQUIPMENT_CT_CATEGORY
GO

IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END

--
-- Удаление ограничений таблицы dbo.SK_MODEL
--
ALTER TABLE dbo.SK_MODEL
  DROP CONSTRAINT FK_SK_MODEL_CT_BRAND
GO
...
--
-- Создание ограничений для таблицы dbo.RS_PRICE
--
ALTER TABLE dbo.RS_PRICE WITH NOCHECK
  ADD CONSTRAINT FK_RS_PRICE_CT_VAT FOREIGN KEY (VatId) REFERENCES dbo.CT_VAT(VatId) ON DELETE NO ACTION ON UPDATE NO ACTION
ALTER TABLE dbo.RS_PRICE WITH NOCHECK
  ADD CONSTRAINT FK_RS_PRICE_RS_PRODUCT FOREIGN KEY (ProductId) REFERENCES dbo.RS_PRODUCT(ProductId) ON DELETE NO ACTION ON UPDATE NO ACTION
GO

IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END

--
-- Создание ограничений для таблицы dbo.RS_PRODUCT
--
ALTER TABLE dbo.RS_PRODUCT WITH NOCHECK
  ADD CONSTRAINT FK_RS_PRODUCT_CT_BRAND FOREIGN KEY (BrandId) REFERENCES dbo.CT_BRAND(BrandId) ON DELETE NO ACTION ON UPDATE NO ACTION
ALTER TABLE dbo.RS_PRODUCT WITH NOCHECK
  ADD CONSTRAINT FK_RS_PRODUCT_CT_IMAGE FOREIGN KEY (ImageId) REFERENCES dbo.CT_IMAGE(ImageId) ON DELETE NO ACTION ON UPDATE NO ACTION
ALTER TABLE dbo.RS_PRODUCT WITH NOCHECK
  ADD CONSTRAINT FK_RS_PRODUCT_SK_EQUIPMENT FOREIGN KEY (EquipmentId) REFERENCES dbo.SK_EQUIPMENT(EquipmentId) ON DELETE NO ACTION ON UPDATE NO ACTION
ALTER TABLE dbo.RS_PRODUCT WITH NOCHECK
  ADD CONSTRAINT FK_RS_PRODUCT_SK_MODEL FOREIGN KEY (ModelId) REFERENCES dbo.SK_MODEL(ModelId) ON DELETE NO ACTION ON UPDATE NO ACTION
GO

IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END

--
-- Создание ограничений для таблицы dbo.SK_EQUIPMENT
--
ALTER TABLE dbo.SK_EQUIPMENT WITH NOCHECK
  ADD CONSTRAINT FK_SK_EQUIPMENT_CT_CATEGORY FOREIGN KEY (CategoryId) REFERENCES dbo.CT_CATEGORY(CategoryId) ON DELETE NO ACTION ON UPDATE NO ACTION
GO

IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END

--
-- Создание ограничений для таблицы dbo.SK_MODEL
--
ALTER TABLE dbo.SK_MODEL WITH NOCHECK
  ADD CONSTRAINT FK_SK_MODEL_CT_BRAND FOREIGN KEY (BrandId) REFERENCES dbo.CT_BRAND(BrandId) ON DELETE NO ACTION ON UPDATE NO ACTION
GO

IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END

--
-- Включение DML триггеров таблицы dbo.RS_PRODUCT
--
GO
ENABLE TRIGGER ALL ON dbo.RS_PRODUCT
GO
